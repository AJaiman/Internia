...
export default function PublicationCard({ publication } : { publication: Publication }) {
    ...
    return (
        <div className="flex flex-row w-full h-20">
            <div className="flex flex-col justify-center pl-4 flex-1 h-20 bg-white/80 rounded-l-[6px]">
            ...
            <Link href="/discover/paper/owueroiweur" className="group flex items-center justify-center w-20 h-20 rounded-r-[6px] bg-white/50">
