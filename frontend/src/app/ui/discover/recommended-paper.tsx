...
export default function RecommendedPaper({ publication } : { publication: LongformPublication }) {
    ...
    return (
        <Link href="/discover/paper/placeholder-url" className="relative flex-shrink-0 flex flex-row w-full h-32 transition hover:translate-x-3">
            ...
            <div className="flex flex-col flex-1 justify-around py-1 pl-8 h-full bg-royalBlue/20 rounded-r-xl">
                <div>
                    <h1 className="text-lg text-royalPurple font-bold">{publication.name}</h1>
                    <div className="w-4/5">
