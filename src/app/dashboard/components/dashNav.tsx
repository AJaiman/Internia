    ...
    return (
        <>
            ...
            <Link href="/dashboard"><img src="/logo.png" alt="Logo" className="w-48 h-12" /></Link>
                <div className="relative flex-grow mx-0 flex justify-center">
                        ...
                        showPfpDropDown ?
                            <div className="rounded-[10px] drop-shadow-md absolute top-[200%] left-[35%] w-[300px] h-fit bg-white">
                                <section className="p-2 border-b border-b-gray-500">
                                    ...
                                    <ul className="px-1">
                                        <li className="cursor-pointer select-none hover:text-blue-400 transition duration-200 text-center pt-1">Account Settings</li>
                                    </ul>
                                </section>
                                <section className=" flex justify-center p-2">
                                    <button className=" text-red-500 hover:text-red-600 transition duration-200" onClick={() => signOut({ redirect: true, callbackUrl: `${window.location.origin}/signInPage`, })}>Sign Out</button>
                                </section>
                            </div>
                            : null
                    }
